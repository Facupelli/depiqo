...
- **Current evidence:** The aggregate only mutates customer, confirm, and cancel; no selection, period, branch, delivery, notes, insurance, or quantity update command exists.
