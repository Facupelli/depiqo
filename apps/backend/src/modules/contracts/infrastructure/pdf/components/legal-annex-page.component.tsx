...
const INSURANCE_TEXT =
  'ARRENDATARIO podrá acogerse a la Cobertura de daños accidentales mediante el pago del 6% del importe del alquiler. Esta cobertura constituye una limitación contractual de responsabilidad entre las partes y no es, en ningún caso, un contrato de seguro. Acogiéndose a ella, la responsabilidad del ARRENDATARIO por daños accidentales sufridos por el equipo durante su uso normal queda limitada a la franquicia correspondiente según el valor de reposición del elemento dañado: hasta 1.000€, franquicia de 100€; de 1.000,01€ a 5.000€, franquicia de 250€; superior a 5.000€, franquicia de 500€. Quedan expresamente excluidos de esta limitación: (a) robo, hurto, pérdida o no devolución del equipo; (b) daños derivados de negligencia grave o uso contrario a las instrucciones del fabricante; (c) daños estéticos que no afecten al funcionamiento. En los supuestos excluidos, el ARRENDATARIO responde conforme al régimen general del presente contrato. Alternativamente, el ARRENDATARIO podrá acreditar póliza de seguro de producción propia que cubra equipo alquilado a terceros, designando al ARRENDADOR como beneficiario, mediante certificado entregado antes de la recogida del equipo. La ausencia de acogimiento a la Cobertura y de acreditación de póliza propia implicará que el ARRENDATARIO responda por la totalidad del coste de reparación o del valor de reposición del equipo, sin limitación de responsabilidad alguna.';
...
export function LegalAnnexPage({
  logoUrl: _logoUrl,
  rentalSignatureUrl,
      ...
      <View style={sharedStyles.headerRow}>
        <View style={sharedStyles.headerRight}>
          <View style={sharedStyles.headerRightContent}>
            <Text style={s.annexLabel}>ANEXO I</Text>
          </View>
        </View>
      </View>
      ...
      <View style={[sharedStyles.frame, { height: 690 }]}>
        <View style={sharedStyles.frameContent}>
          <View>
            ...
            <Text style={s.sectionTitle}>Limitación de responsabilidad por daños accidentales</Text>
          ...
          <View style={sharedStyles.signatureRow}>
            {signedSummary ? <ElectronicAcceptanceBlock summary={signedSummary} /> : <EmptyCustomerSignatureBlock />}
