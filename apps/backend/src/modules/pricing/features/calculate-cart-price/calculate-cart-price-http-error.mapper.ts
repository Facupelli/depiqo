...
> = {
  InvalidCartSelection: {
    type: createV2ProblemType('pricing/invalid-cart-selection'),
  ...
  RentalOfferNotSelectable: {
    type: createV2ProblemType('pricing/rental-offer-not-selectable'),
  ...
  RentableItemInactive: {
    type: createV2ProblemType('pricing/rentable-item-inactive'),
  ...
  CouponRequiresCustomer: {
    type: createV2ProblemType('pricing/coupon-requires-customer'),
    title: 'Coupon requires customer',
    status: HttpStatus.UNPROCESSABLE_ENTITY,
    detail: 'Coupon pricing requires a customer.',
  },
  CouponNotApplicable: {
    type: createV2ProblemType('pricing/coupon-not-applicable'),
    title: 'Coupon not applicable',
    status: HttpStatus.UNPROCESSABLE_ENTITY,
    detail: 'The requested coupon could not be applied to this cart.',
  },
  PricingCalculationFailed: {
    type: createV2ProblemType('pricing/calculation-failed'),
...
export function toCalculateCartPriceProblem(error: CalculateCartPriceApplicationError): V2ProblemException {
