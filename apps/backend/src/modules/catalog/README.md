...
- `CatalogEquipmentTypeRentalFacts` summarizes current admin-configurable standalone and package relationships for requested Equipment Types and publishes the branch-scoped standalone Rental Offer IDs eligible for Pricing enrichment.
