...
> = {
  ...
  RentableItemNotInDraftStatus: {
    type: createV2ProblemType('catalog/rentable-item-not-in-draft-status'),
  ...
  RentableItemHasNoRequirements: {
    type: createV2ProblemType('catalog/rentable-item-has-no-requirements'),
  ...
  RentableItemHasNoRentalOffers: {
    type: createV2ProblemType('catalog/rentable-item-has-no-rental-offers'),
  ...
  RentableItemHasNoActivePricing: {
    type: createV2ProblemType('catalog/rentable-item-has-no-active-pricing'),
  ...
  RentableItemHasInsufficientActiveAssets: {
    type: createV2ProblemType('catalog/rentable-item-has-insufficient-active-assets'),
...
export function toActivateRentableItemProblem(error: ActivateRentableItemApplicationError): V2ProblemException {
