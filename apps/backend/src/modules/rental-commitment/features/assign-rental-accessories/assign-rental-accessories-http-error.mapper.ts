...
const ProblemCatalog: Record<AssignRentalAccessoriesApplicationErrorCode, ProblemDefinition> = {
  ...
  RentalStatusDoesNotAllowAccessoryAssignment: {
    type: createProblemType('rental-commitment/rental-status-does-not-allow-accessory-assignment'),
  ...
  InvalidAccessoryQuantity: {
    type: createProblemType('rental-commitment/invalid-accessory-quantity'),
    title: 'Invalid accessory quantity',
    status: HttpStatus.UNPROCESSABLE_ENTITY,
    detail: 'Accessory quantities must be positive integers.',
  },
  DuplicateAccessorySelection: {
    type: createProblemType('rental-commitment/duplicate-accessory-selection'),
  ...
  DuplicateAccessoryAsset: {
    type: createProblemType('rental-commitment/duplicate-accessory-asset'),
  ...
  SourceRentalDemandLineNotFound: {
    type: createProblemType('rental-commitment/source-rental-demand-line-not-found'),
  ...
  AccessoryAssetNotFound: {
    type: createProblemType('rental-commitment/accessory-asset-not-found'),
    title: 'Accessory asset not found',
    status: HttpStatus.NOT_FOUND,
    detail: 'One of the selected accessory assets could not be found.',
  },
  AccessoryAssetNotAssignable: {
    type: createProblemType('rental-commitment/accessory-asset-not-assignable'),
  ...
  AccessoryAssetUnavailable: {
    type: createProblemType('rental-commitment/accessory-asset-unavailable'),
...
export function toAssignRentalAccessoriesProblem(error: AssignRentalAccessoriesApplicationError): ProblemException {
