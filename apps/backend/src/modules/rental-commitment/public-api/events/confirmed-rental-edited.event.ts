...
export interface ConfirmedRentalEditedEventProps {
  eventId?: string;
  tenantId: string;
  rentalId: string;
...
export class ConfirmedRentalEditedEvent implements DomainEvent {
  readonly eventId: string;
  readonly eventName = ConfirmedRentalEditedEvent.name;
  ...
  constructor(props: ConfirmedRentalEditedEventProps) {
