...
import { V2AssetInventoryModule } from '../asset-inventory/asset-inventory.module';
import { V2CatalogModule } from '../catalog/catalog.module';
import { V2PricingModule } from '../pricing/pricing.module';
import { V2TenantManagementModule } from '../tenant-management/tenant-management.module';
...
@Module({
  imports: [V2TenantManagementModule, V2AssetInventoryModule, V2CatalogModule, V2PricingModule],
  controllers: [
...
export class V2OfferingSetupModule {}
