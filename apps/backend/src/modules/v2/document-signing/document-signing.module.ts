...
import { V2ContractsModule } from '../contracts/contracts.module';
...
@Module({
  imports: [NotificationsModule, ObjectStorageModule, V2ContractsModule, V2TenantManagementModule],
  controllers: [
...
export class V2DocumentSigningModule {}
