...
import { V2AuthModule } from './auth/auth.module';
...
import { V2TenantContextModule } from './tenant-context/tenant-context.module';
...
@Module({
  imports: [V2AuthModule, V2TenantContextModule],
  controllers: [
...
export class V2TenantManagementModule {}
