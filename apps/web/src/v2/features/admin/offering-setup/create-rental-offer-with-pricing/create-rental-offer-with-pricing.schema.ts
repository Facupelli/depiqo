...
} from "@/v2/features/pricing/create-rate-plan/create-rate-plan.schema";
import {
	type AttachRatePlanToRentalOfferFormValues,
	attachRatePlanToRentalOfferFormSchema,
} from "@/v2/features/pricing/rental-offer-pricings/attach-rate-plan-to-rental-offer/attach-rate-plan-to-rental-offer.schema";
