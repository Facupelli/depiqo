		...
		<>
			...
			>
				<FieldGroup>
					...
					<form.Field name="excludeFromNewArrivals">
						{(field) => (
							<div className="grid grid-cols-[1fr_auto] items-start gap-8 rounded-xl border border-border bg-card px-5 py-4">
								<div>
								...
								<div className="pt-1">
									<Switch
										...
										aria-label="Ocultar de nuevos ingresos"
									/>
								</div>
							</div>
						)}
