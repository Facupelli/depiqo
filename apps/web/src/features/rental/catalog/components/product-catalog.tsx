...
import { useV2RentalOfferCardState } from "@/v2/features/rental-commitment/cart/use-v2-rental-offer-card-state";
...
import { useStorefrontRentalOfferListView } from "@/v2/features/storefront/rental-offers/storefront-rental-offer-list-view.queries";
