...
import { useRegisterBusiness } from "./register-business.mutation";
import {
	registerBusinessFormDefaults,
	registerBusinessFormSchema,
	toRegisterBusinessDto,
} from "./register-business-form.schema";

const formId = "register-user-tenant";

export function RegisterBusinessPage() {
	const { mutateAsync: registerBusiness, isPending } = useRegisterBusiness();

	const form = useForm({
		defaultValues: registerBusinessFormDefaults,
		validators: {
			onSubmit: registerBusinessFormSchema,
		},
		onSubmit: async ({ value }) => {
			const dto = toRegisterBusinessDto(value);
			try {
