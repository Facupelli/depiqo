/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --env-file .wrangler-types.env` (hash: 4dbcbdd4b792677537999bbe90b4eb45)
// Runtime types generated with workerd@1.20260507.1 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		CUSTOMERS_BUCKET: R2Bucket;
		CLOUDFLARE_R2_BUCKET_NAME: "equipment";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_R2_BUCKET_NAME" | "VITE_R2_PUBLIC_URL" | "VITE_BRANDING_R2_PUBLIC_URL" | "NODE_ENV">> {}
}
