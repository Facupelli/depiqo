/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e70ae901a283d040951b62e14799acae)
// Runtime types generated with workerd@1.20260507.1 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		CUSTOMERS_BUCKET: R2Bucket;
		NODE_ENV: "production";
		BACKEND_URL: string;
		BFF_INTERNAL_TOKEN: string;
		STOREFRONT_TENANT_JWT_SECRET: string;
		STOREFRONT_TENANT_JWT_ISSUER: string;
		STOREFRONT_TENANT_JWT_AUDIENCE: string;
		SESSION_SECRET: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_R2_ACCESS_KEY_ID: string;
		CLOUDFLARE_R2_SECRET_ACCESS_KEY: string;
		CLOUDFLARE_R2_BUCKET_NAME: string;
		BRANDING_TOKEN_VALUE: string;
		R2_BRANDING_ACCESS_KEY_ID: string;
		R2_BRANDING_SECRET_ACCESS_KEY: string;
		CLOUDFLARE_R2_BRANDING_BUCKET_NAME: string;
		CUSTOMERS_TOKEN_VALUE: string;
		R2_CUSTOMERS_ACCESS_KEY_ID: string;
		R2_CUSTOMERS_SECRET_ACCESS_KEY: string;
		R2_CUSTOMERS_BUCKET_NAME: string;
		TOKEN: string;
		ACCESS_KEY: string;
		SECRET: string;
		endpoint: string;
		VITE_R2_PUBLIC_URL: string;
		VITE_BRANDING_R2_PUBLIC_URL: string;
		INTERNAL_API_TOKEN: string;
		ROOT_DOMAIN: string;
		VITE_GOOGLE_CLIENT_ID: string;
		VITE_SHARED_AUTH_ORIGIN: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "BACKEND_URL" | "BFF_INTERNAL_TOKEN" | "STOREFRONT_TENANT_JWT_SECRET" | "STOREFRONT_TENANT_JWT_ISSUER" | "STOREFRONT_TENANT_JWT_AUDIENCE" | "SESSION_SECRET" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_R2_ACCESS_KEY_ID" | "CLOUDFLARE_R2_SECRET_ACCESS_KEY" | "CLOUDFLARE_R2_BUCKET_NAME" | "BRANDING_TOKEN_VALUE" | "R2_BRANDING_ACCESS_KEY_ID" | "R2_BRANDING_SECRET_ACCESS_KEY" | "CLOUDFLARE_R2_BRANDING_BUCKET_NAME" | "CUSTOMERS_TOKEN_VALUE" | "R2_CUSTOMERS_ACCESS_KEY_ID" | "R2_CUSTOMERS_SECRET_ACCESS_KEY" | "R2_CUSTOMERS_BUCKET_NAME" | "TOKEN" | "ACCESS_KEY" | "SECRET" | "endpoint" | "VITE_R2_PUBLIC_URL" | "VITE_BRANDING_R2_PUBLIC_URL" | "INTERNAL_API_TOKEN" | "ROOT_DOMAIN" | "VITE_GOOGLE_CLIENT_ID" | "VITE_SHARED_AUTH_ORIGIN">> {}
}
